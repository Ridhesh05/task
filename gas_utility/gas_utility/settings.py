...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(hours=int(os.environ.get('JWT_EXPIRATION_HOURS', 24))),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Gas Utility Customer Service API',
    'DESCRIPTION': 'API for managing gas utility customer service requests',
    'VERSION': '1.0.0',
